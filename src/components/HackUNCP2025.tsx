...
export default function Recap2025Section() {
  ...
  const stats = [
    { number: "42", label: "Participants", icon: <Users className="h-6 w-6" />, color: "from-[#3E8B94] to-cyan-600" },
    { number: "12", label: "Projects Submitted", icon: <Code className="h-6 w-6" />, color: "from-[#B8232F] to-red-600" },
    { number: "20", label: "Judges", icon: <Star className="h-6 w-6" />, color: "from-slate-400 to-slate-600" },
    { number: "$7,486", label: "Prizes Awarded", icon: <Trophy className="h-6 w-6" />, color: "from-gray-400 to-gray-600" }
  ];
  ...
  const winners = [
    ...
    },
    {
      ...
      project: "LiftMate",
      prize: "$765 + AirPods 4",
      color: "from-[#3E8B94] to-teal-700",
      link: "https://devpost.com/software/liftmate"
    }
  ];

  const trackWinners = [
    { track: "Sustainability Track", project: "Firesafe", prize: "$594", link: "https://devpost.com/software/firesafe", icon: <Lightbulb className="w-4 h-4" />, color: "from-slate-400 to-slate-600" },
    { track: "Education Track", project: "Baisly", prize: "$593", link: "https://devpost.com/software/baisly", icon: <Brain className="w-4 h-4" />, color: "from-[#3E8B94] to-cyan-600" },
    { track: "Interactive Media Track", project: "Web Bestie", prize: "$592", link: "https://devpost.com/software/web-bestie", icon: <Sparkles className="w-4 h-4" />, color: "from-[#B8232F] to-red-600" },
    { track: "Healthcare Track", project: "AI-You-Doin'", prize: "$592", link: "https://devpost.com/software/ai-you-doin", icon: <Shield className="w-4 h-4" />, color: "from-gray-400 to-gray-600" },
  ...
  const achievements = [
    ...
    },
    {
      ...
      color: "from-[#B8232F] to-red-700",
      accentColor: "[#B8232F]",
      pattern: "radial-gradient(circle at 70% 40%, rgba(184, 35, 47, 0.3) 0%, transparent 50%)"
    },
    {
    ...
    },
    {
      ...
      description: "Empowering tomorrow with Intelligent AI Agents - defining innovation's landscape",
      color: "from-gray-500 to-gray-700",
      accentColor: "gray-400",
      pattern: "radial-gradient(circle at 80% 20%, rgba(107, 114, 128, 0.3) 0%, transparent 50%)"
    },
    {
    ...
    },
    {
      ...
      color: "from-[#3E8B94] to-teal-800",
      accentColor: "[#3E8B94]",
      pattern: "radial-gradient(circle at 40% 10%, rgba(62, 139, 148, 0.3) 0%, transparent 50%)"
    }
  ];
  ...
  return (
    <section id="2025-recap" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-[#3E8B94]/40 via-transparent to-[#B8232F]/40"></div>
      <div className="absolute inset-0 bg-gradient-to-bl from-slate-900/30 via-transparent to-gray-900/30"></div>
        ...
        {[...Array(30)].map((_, i) => (
          ...
          >
            <div className={`w-full h-full ${
              i % 4 === 0 ? 'rounded-full bg-gradient-to-r from-[#3E8B94] to-cyan-600' :
              i % 4 === 1 ? 'rounded bg-gradient-to-r from-[#B8232F] to-red-600 rotate-45' :
              i % 4 === 2 ? 'rounded-full bg-gradient-to-r from-slate-400 to-slate-600' :
              'rounded bg-gradient-to-r from-gray-400 to-gray-600 rotate-12'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="relative inline-block mb-10">
            ...
            <div className="relative flex items-center gap-4 bg-white/10 backdrop-blur-2xl border border-white/30 rounded-full px-12 py-6 shadow-2xl">
              <Sparkles className="h-8 w-8 text-[#3E8B94] animate-spin" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F] font-black text-xl">HackUNCP 2025 Showcase</span>
              <Trophy className="h-8 w-8 text-[#B8232F] animate-bounce" />
            </div>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <h2 className="relative text-6xl md:text-8xl font-black leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] via-[#B8232F] to-slate-400 animate-gradient-text">
                SPECTACULAR!
              </span>
            </h2>
          </div>
          ...
          <p className="text-2xl md:text-3xl text-gray-200 max-w-5xl mx-auto leading-relaxed">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F] font-bold"> AI solutions that matter</span>
          </p>
        </div>
        ...
        <div className="mb-24">
          <div className="relative group">
            <div className="absolute -inset-4 bg-gradient-to-r from-[#3E8B94]/30 via-[#B8232F]/30 to-slate-500/30 rounded-3xl blur-3xl group-hover:blur-2xl transition-all duration-1000"></div>
              ...
              {photoSlides.map((_, index) => (
                <button
                  ...
                  className={`h-3 rounded-full transition-all duration-500 border border-white/30 ${
                    index === currentSlide 
                      ? 'w-12 bg-gradient-to-r from-[#3E8B94] to-[#B8232F] shadow-lg' 
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <h3 className="text-4xl md:text-5xl font-black text-white mb-4">
              Impact <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F]">Metrics</span>
            </h3>
            <div className="w-32 h-1 bg-gradient-to-r from-[#3E8B94] to-[#B8232F] mx-auto rounded-full"></div>
          </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <h3 className="text-5xl md:text-6xl font-black text-white mb-6">
              Champion <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B8232F] to-red-500">Winners</span>
            </h3>
            <div className="w-32 h-1 bg-gradient-to-r from-[#B8232F] to-red-500 mx-auto rounded-full mb-4"></div>
            ...
            {winners.map((winner, index) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-10 hover:bg-white/10 transition-all duration-700 hover:scale-105 hover:-rotate-1 shadow-xl">
                  ...
                  <h5 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F] mb-8">{winner.project}</h5>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-[#3E8B94] font-black text-xl">{winner.prize}</span>
                    <a 
                      href={winner.link}
                      target="_blank"
          ...
          <div className="mb-16">
            <h4 className="text-4xl font-black text-white text-center mb-12">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F]">Track Champions</span>
            </h4>
              ...
              {trackWinners.map((winner, index) => (
                ...
                >
                  ...
                  <div className="relative text-center">
                    ...
                    <span className="text-[#3E8B94] font-bold text-lg block mb-4">{winner.prize}</span>
                    <a 
                      href={winner.link}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group/link flex items-center justify-center gap-2 text-white hover:text-[#3E8B94] transition-colors duration-300"
                    >
          ...
          <div className="text-center">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-4 px-12 py-6 bg-gradient-to-r from-[#3E8B94] via-[#B8232F] to-slate-500 text-white font-black rounded-full hover:from-[#2e6c78] hover:via-[#a01e29] hover:to-slate-700 transition-all duration-500 transform hover:scale-110 shadow-2xl text-xl"
            >
        ...
        <div className="relative">
          <div className="text-center mb-20">
            <div className="relative inline-block mb-8">
              <div className="absolute inset-0 bg-gradient-to-r from-[#3E8B94]/40 to-[#B8232F]/40 rounded-full blur-2xl"></div>
              <div className="relative flex items-center gap-4 bg-white/10 backdrop-blur-2xl border border-white/30 rounded-full px-10 py-5">
                <Star className="h-7 w-7 text-[#3E8B94] animate-pulse" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F] font-black text-xl">Organizational Excellence</span>
                <Award className="h-7 w-7 text-[#B8232F] animate-bounce" />
              </div>
            </div>
            
            <h3 className="text-5xl md:text-6xl font-black text-white mb-6">
              Behind the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] via-[#B8232F] to-slate-400 animate-gradient-text">Excellence</span>
            </h3>
          ...
          <div className="text-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-[#3E8B94]/20 via-[#B8232F]/20 to-slate-500/20 rounded-3xl blur-3xl"></div>
              <div className="relative bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-12 shadow-2xl">
                <h4 className="text-4xl font-black text-white mb-10">
                  HackUNCP <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-[#B8232F]">2025 Legacy</span>
                </h4>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#3E8B94] to-cyan-700 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-xl">
                      <Calendar className="w-8 h-8 text-white" />
                    </div>
                    <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#3E8B94] to-cyan-600 mb-3">March 2025</div>
                    <div className="text-gray-200 font-bold text-lg">Historic Innovation Event</div>
                  </div>
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#B8232F] to-red-700 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-xl">
                      <MapPin className="w-8 h-8 text-white" />
                    </div>
                    <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#B8232F] to-red-600 mb-3">UNCP Campus</div>
                    <div className="text-gray-200 font-bold text-lg">Innovation Epicenter</div>
                  </div>
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-gradient-to-br from-slate-500 to-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-xl">
                      <Clock className="w-8 h-8 text-white" />
                    </div>
                    <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-slate-600 mb-3">24 Hours</div>
